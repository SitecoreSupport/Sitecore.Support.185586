<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeBehind="Default.aspx.cs" Inherits="Sitecore.Support.CustomDefaultLogin" %>
                            ...
                            <div id="credentialsError" class="scMessageBar scWarning" style="display: none">
                                ...
                                <div class="scMessageBarTextContainer">
                                    <div class="scMessageBarText">
                                        <asp:Literal ID="ltrLogin" Text="Please enter your login credentials." runat="server"></asp:Literal>
                                    </div>
                                </div>
                            </div>
